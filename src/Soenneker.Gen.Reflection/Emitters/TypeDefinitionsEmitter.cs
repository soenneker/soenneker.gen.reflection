...
internal static class TypeDefinitionsEmitter
{
    ...
    private static void EmitTypeInfoGen(StringBuilder sb)
    {
        ...
        sb.AppendLine("        private readonly Func<string, int>? _fieldIndex;");
        sb.AppendLine("        private readonly Func<string, int>? _propertyIndex;");
        sb.AppendLine("        private readonly Func<string, int>? _methodIndex;");
        sb.AppendLine("        private readonly string? _underlyingTypeName;");
        sb.AppendLine("        private readonly string[]? _genericTypeArgumentNames;");
        sb.AppendLine();
        sb.AppendLine("        public TypeInfoGen(string name, string fullName, string assemblyQualifiedName, bool isValueType, bool isReferenceType, bool isGenericType, bool isNullable, FieldInfoGen[] fields, PropertyInfoGen[] properties, MethodInfoGen[] methods, string? underlyingTypeName, string[]? genericTypeArgumentNames, Func<string, int>? fieldIndex = null, Func<string, int>? propertyIndex = null, Func<string, int>? methodIndex = null)");
        sb.AppendLine("        {");
        ...
        sb.AppendLine("            _fieldIndex = fieldIndex;");
        sb.AppendLine("            _propertyIndex = propertyIndex;");
        sb.AppendLine("            _methodIndex = methodIndex;");
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            if (_propertyIndex != null) { int index = _propertyIndex(name); return index < 0 ? null : _properties[index]; }");
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            if (_fieldIndex != null) { int index = _fieldIndex(name); return index < 0 ? null : _fields[index]; }");
        ...
        sb.AppendLine("        {");
        sb.AppendLine("            if (_methodIndex != null) { int index = _methodIndex(name); return index < 0 ? null : _methods[index]; }");
    ...
    private static void EmitPropertyInfoGen(StringBuilder sb)
    {
        ...
        sb.AppendLine("        private readonly object? _getter;");
        sb.AppendLine("        private readonly object? _setter;");
        sb.AppendLine("        private readonly Delegate? _typedGetter;");
        sb.AppendLine("        private readonly Delegate? _typedSetter;");
        sb.AppendLine();
        sb.AppendLine("        public PropertyInfoGen(string name, TypeInfoGen propertyType, bool canRead, bool canWrite, object? getter = null, object? setter = null, Delegate? typedGetter = null, Delegate? typedSetter = null)");
        sb.AppendLine("        {");
        sb.AppendLine("            _name = name;");
        ...
        sb.AppendLine("            _getter = getter;");
        sb.AppendLine("            _setter = setter;");
        sb.AppendLine("            _typedGetter = typedGetter;");
        sb.AppendLine("            _typedSetter = typedSetter;");
        sb.AppendLine("        }");
        sb.AppendLine();
        sb.AppendLine("        public string Name => _name;");
        ...
        sb.AppendLine("        /// <summary>Resolves a compatible typed getter once for repeated access without boxing. Throws if the signature is unavailable.</summary>");
        sb.AppendLine("        public Func<TInstance, TValue> GetGetter<TInstance, TValue>() => _typedGetter as Func<TInstance, TValue> ?? throw new InvalidOperationException(\"No generated getter with this signature.\");");
        sb.AppendLine("        /// <summary>Resolves a typed setter for a reference-type receiver. Throws if the signature is unavailable.</summary>");
        sb.AppendLine("        public Action<TInstance, TValue> GetSetter<TInstance, TValue>() where TInstance : class => _typedSetter as Action<TInstance, TValue> ?? throw new InvalidOperationException(\"No generated setter with this signature.\");");
        sb.AppendLine("        public object? Getter => _getter;");
        sb.AppendLine("        public object? Setter => _setter;");
        sb.AppendLine();
        sb.AppendLine("        public object? GetValue(object? obj)");
